...
material_1 = Material(1, 1, 1*eye(3), 100e3, 0.3, 0*ones(3, 1));
material_2 = Material(1, 1, 1*eye(3), 100e9, 0.3, 2e-5*ones(3, 1));
    ...
    for p_alpha = [3]
        for k = 65*[1e4]
            for penalty = [100]
                ...
                topOpt = ThermallyActuatedProblemUniform(mechFEM_i, options, volumeFraction, penalty);
