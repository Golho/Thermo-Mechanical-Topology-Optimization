function Vector2VTK(filename, matrix, format, label, header, cellData)
...
[numVectorComp, Nx, Ny, Nz] = size(matrix);
assert(numVectorComp == 3, "The number of vector components must equal 3");
